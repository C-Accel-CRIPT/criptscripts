...
def define_materials(project: c.Project) -> list[c.Material]:
    ...
    dueterated_chloroform = c.Material(
        ...
        identifiers=[
            ...
            c.Identifier(
                "names",
                ["chloroform-d", "deuterochloroform", "trichloro(deuterio)methane"],
            ),
        ...
        properties=[
            ...
            c.Property(key="color", value="colorless"),
            c.Property(
                key="molar_mass", value=120.384, unit="g/mol", method="prescribed"
            ),
            c.Property(
                key="density",
                value=1.5,
    ...
    nitrogen = c.Material(
        ...
        properties=[
            ...
            c.Property(key="color", value="colorless"),
            c.Property(
                key="molar_mass", value=28.014, unit="g/mol", method="prescribed"
            ),
            c.Property(
                key="density",
                value=1.25,
    ...
    argon = c.Material(
        ...
        properties=[
            ...
            c.Property(key="color", value="colorless"),
            c.Property(
                key="molar_mass", value=39.95, unit="g/mol", method="prescribed"
            ),
            c.Property(
                key="density",
                value=1.784,
    ...
    styrene = c.Material(
        ...
        properties=[
            ...
            c.Property(key="color", value="colorless"),
            c.Property(
                key="molar_mass", value=104.15, unit="g/mol", method="prescribed"
            ),
            c.Property(
                key="density",
                value=0.906,
    ...
    toluene = c.Material(
        ...
        properties=[
            ...
            c.Property(key="color", value="colorless"),
            c.Property(
                key="molar_mass", value=92.141, unit="g/mol", method="prescribed"
            ),
            c.Property(
                key="density",
                value=0.87,
    ...
    thf = c.Material(
        ...
        properties=[
            ...
            c.Property(key="color", value="colorless"),
            c.Property(
                key="molar_mass", value=72.107, unit="g/mol", method="prescribed"
            ),
            c.Property(
                key="density",
                value=0.8876,
    ...
    butanol = c.Material(
        ...
        properties=[
            ...
            c.Property(key="color", value="colorless"),
            c.Property(
                key="molar_mass", value=74.123, unit="g/mol", method="prescribed"
            ),
            c.Property(
                key="density",
                value=0.81,
    ...
    secBuLi = c.Material(
        ...
        properties=[
            c.Property(
                key="molar_mass", value=64.06, unit="g/mol", method="prescribed"
            ),
        ],
    )
